...
- Source: INSPIRE-HEP (six HEP/MHD-aligned categories: plasma, MHD, QGP, heavy ions, detectors, tokamaks).
...
4. **0.85** — *Chiral Anomalous Magnetohydrodynamics in action: effective field theory and holography* (Baggioli et al., JHEP 2025, 126)  
   EFT for chiral fluids with dynamical EM fields and axial anomaly; resonance phases match 0.9 h harmonic structure.
...
- No prior claims of a universal **χ ≈ 0.15** causality/stability boundary were found; empirical LUFT result remains unique.
- 2024–2025 causality papers provide theoretical bounds that the LUFT dataset can pin down empirically (1.48M+ zero-violation points).
- Chiral/anomalous MHD literature (2025) aligns qualitatively with the observed 66 h suppression and 0.9 h harmonics, strengthening cross-scale links from magnetosphere to QGP.
